...
hero:
  ...
  tagline: Fourteen batteries-included tools to read, search, edit, patch, run, and monitor code over a workspace. Transport-agnostic and confined to your workspace by default — embed them in any agent loop, or drive them from a transport of your own.
  image:
    src: /logo.svg
...
of fourteen tools — the primitives an agent needs to read, search, edit, run, and monitor code:
