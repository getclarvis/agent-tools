...
const description =
  "A minimal, opinionated set of coding tools — read/search/edit/patch/move/bash/monitor — for driving an LLM agent over a workspace. Transport-agnostic, embeddable as a plain library.";
